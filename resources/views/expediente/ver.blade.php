...
@section('contenido')
	...
	<div class='row p-2'>
		...
		<div class='col-sm-4'>
			...
			<input class='form-control'  id='apellidos_profesor' type=text placeholder='buscar aquí'  onKeyUp='buscar_profesor(this.value)'   @if($expediente->id)value='{{$expediente->profesor->apellido1 .' '. $expediente->profesor->apellido1}}'@endif>
		...
		<div class='col-sm-4'>
			<label for='apellido2'>Nombre</label>
			<input class='form-control'  id='nombre_profesor' readonly type=text  @if($expediente->profesor) value='{{$expediente->profesor->nombre}}'@endif>
		</div>
		<div class='col-sm-2'></div>
	</div>
	<div class='row p-2'>
